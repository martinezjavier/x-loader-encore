...
omap3430_edp1_hynix_config :    unconfig
	@./mkconfig omap3430_edp1 arm omap3 omap3430_edp1; \
	echo "#define CONFIG_SDRAM_HYNIX" >> ./include/config-2.h; \
    echo "#define CFG_NAND 1" >> ./include/config-2.h; \
    echo "#undef CFG_NAND" >> ./include/config-2.h; \
	cat ./include/config-2.h >> ./include/config.h; \
	rm ./include/config-2.h;

omap3430_edp1_micron_config :    unconfig
	@./mkconfig omap3430_edp1 arm omap3 omap3430_edp1; \
	echo "#define CONFIG_SDRAM_MICRON" >> ./include/config-2.h; \
	cat ./include/config-2.h >> ./include/config.h; \
	rm ./include/config-2.h;
...
omap3621zoom3_config :    unconfig
	@./mkconfig omap3621_zoom3 arm omap3 omap3430labrador; \
